 ...
 */
final class Version20210418162820 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, reason_id INT NOT NULL, post_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_C42F778459BB1592 (reason_id), INDEX IDX_C42F77844B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
